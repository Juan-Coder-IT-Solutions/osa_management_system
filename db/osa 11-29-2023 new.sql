...
-- Dumping data for table osa_db.tbl_checklist_requirements: ~3 rows (approximately)
/*!40000 ALTER TABLE `tbl_checklist_requirements` DISABLE KEYS */;
INSERT INTO `tbl_checklist_requirements` (`cr_id`, `cr_desc`, `date_added`) VALUES
	(2, 'dfshg', '2023-11-22 08:53:43'),
	(3, 'yuto', '2023-11-22 08:53:48');
/*!40000 ALTER TABLE `tbl_checklist_requirements` ENABLE KEYS */;

-- Dumping structure for table osa_db.tbl_clubs
...
-- Dumping data for table osa_db.tbl_clubs: ~2 rows (approximately)
/*!40000 ALTER TABLE `tbl_clubs` DISABLE KEYS */;
INSERT INTO `tbl_clubs` (`club_id`, `club_name`, `date_added`) VALUES
	(1, 'test', '2023-11-21 16:08:31'),
	(2, 'awetawetawet', '2023-11-21 16:19:08');
/*!40000 ALTER TABLE `tbl_clubs` ENABLE KEYS */;

-- Dumping structure for table osa_db.tbl_clubs_requirements
CREATE TABLE IF NOT EXISTS `tbl_clubs_requirements` (
...
-- Dumping data for table osa_db.tbl_clubs_requirements: ~3 rows (approximately)
/*!40000 ALTER TABLE `tbl_clubs_requirements` DISABLE KEYS */;
INSERT INTO `tbl_clubs_requirements` (`id`, `cr_id`, `club_id`, `date_added`) VALUES
	(42, 2, 2, '2023-11-28 15:40:38'),
	(43, 3, 2, '2023-11-28 15:40:38');
...
-- Dumping data for table osa_db.tbl_messages: ~37 rows (approximately)
...
INSERT INTO `tbl_services` (`services_id`, `services_desc`, `date_added`) VALUES
...
-- Dumping data for table osa_db.tbl_users: ~2 rows (approximately)
